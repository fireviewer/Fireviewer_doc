...
| Satellite observations | Copernicus Data Space STAC discovery and automatic planning cover Sentinel-2 L2A, Sentinel-3 SLSTR FRP NRT/NTC, CLMS daily 300 m burnt area, and Sentinel-1 GRD metadata. The CPU path decodes CLMS DOB/CP/BF burn-scar masks and classified Sentinel-3 vegetation-fire points. NASA FIRMS supplies MODIS and VIIRS pixel footprints. Every derived observation keeps time, geometry, accuracy, metrics, source revision, and attribution without retaining raw claim payloads. | The real CDSE S3 path still requires free account credentials and live Azure acceptance. Sentinel-1 has discovery only. Prithvi/MegaLoc remain optional GPU evidence and are not required for deterministic CLMS/FIRMS/FRP processing. |
